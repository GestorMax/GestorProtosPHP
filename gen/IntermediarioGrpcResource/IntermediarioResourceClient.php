...
class IntermediarioResourceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \IntermediarioGrpcResource\LuciusBalanceMensualizadoRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\ServerStreamingCall
     */
    public function ListLuciusBalanceMensualizado(\IntermediarioGrpcResource\LuciusBalanceMensualizadoRequest $argument,
      $metadata = [], $options = []) {
        return $this->_serverStreamRequest('/intermediarioGrpcResource.IntermediarioResource/ListLuciusBalanceMensualizado',
        $argument,
        ['\IntermediarioGrpcResource\LuciusBalanceMensualizadoResponse', 'decode'],
        $metadata, $options);
    }
